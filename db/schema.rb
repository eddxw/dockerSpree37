...
ActiveRecord::Schema.define(version: 2019_05_10_142537) do
  ...
  create_table "spree_order_events_trackers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_spree_order_events_trackers_on_order_id"
    t.index ["user_id"], name: "index_spree_order_events_trackers_on_user_id"
  end
